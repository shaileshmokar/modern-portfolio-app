...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const serviceId = "adadad";
      const templateId = "adadad";
      const publicKey = "Adad";
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-sm font-medium tracking-wider text-secondary-foreground uppercase animate-fade-in">
            Get In Touch
          </span>
          <h2 className="text-4xl md:text-5xl font-bold mt-5 mb-6 text-secondary-foreground animate-fade-in animation-delay-100">
            Let's build{" "}
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-6 animate-fade-in animation-delay-400">
            <div className="galss rounded-3xl p-8">
