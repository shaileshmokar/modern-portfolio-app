    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mx-auto max-w-4xl mb-16">
          <span className="text-secondary-foreground text-sm tracking-wider uppercase animate-fade-in">
            Featured Work
          </span>
          <h2 className="text-4xl md:text-5xl text-secondary-foreground font-bold mt-4 mb-6 leading-tight animate-fade-in animation-delay-100">
            Projects that{" "}
