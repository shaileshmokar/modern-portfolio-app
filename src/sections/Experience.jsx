    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16 space-y-4">
          <span className="text-secondary-foreground text-sm uppercase font-medium tracking-wider animate-fade-in">
            Career Journey
          </span>
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {experiences.map((exp, idx) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-0 md:left-1/2  w-3 h-3 rounded-full bg-primary -translate-x-1/2 ring-4 ring-background z-10">
                  {exp.current && (
